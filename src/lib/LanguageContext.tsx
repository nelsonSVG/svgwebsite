...
const translations = {
  en: {
    ...
    'about.subtitle': 'Our Statement',
    'about.title': 'Digital excellence is not an act, but a habit.',
  ...
  es: {
    ...
    'about.subtitle': 'Nuestro Manifiesto',
    'about.title': 'La excelencia digital no es un acto, sino un hábito.',
